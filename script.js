...
const sortedFoods = foodoriginaldata.slice().sort((a, b) => b.protiens - a.protiens);
...
function sortedcabfood(){
  const sortedFoods = foodoriginaldata.slice().sort((a, b) => b.cab - a.cab);
